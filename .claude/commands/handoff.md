Alias for /session-handoff. Review THIS conversation — from the first message to now. Do NOT read session logs or historical files. Output a handoff summary for this session only in the chat. Aim for under 50 lines; hard cap 150 lines.
